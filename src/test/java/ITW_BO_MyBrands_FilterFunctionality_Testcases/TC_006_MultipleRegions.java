...
public class TC_006_MultipleRegions extends ITW_BaseClass {
	
	
	@Test(priority=4)
	public void MultipleRegionsTest() throws InterruptedException {
		...
		ITW_LoginPage lp=new ITW_LoginPage(driver);
		 ...
		 log.info("**** TC_006_Multiple Regions Testcase Execution is Completed ****");
	}
