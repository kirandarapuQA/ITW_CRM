...
public class TC_032_PCD_Yes extends ITW_BaseClass{

	@Test(priority=25)
	public void Select_PCD_Yesopt_Test() throws InterruptedException{
		...
		pcdp.click_PCD_Yes_opt();
		Thread.sleep(1000);
		pcdp.clickApplyFiltersBtn();
		
		log.info("**** TC_032_PCD_Yes_ Testcase Executed successfully ****");
	}
}
