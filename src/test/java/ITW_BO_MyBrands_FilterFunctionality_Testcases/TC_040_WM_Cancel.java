...
public class TC_040_WM_Cancel extends ITW_BaseClass{
	
	@Test(priority=30)
	public void WM_CancelbtnFunTest() throws InterruptedException {
		...
		log.info("**** TC_040_WM_Cancel_Testcase execution completed successfully completed ****");
	}
