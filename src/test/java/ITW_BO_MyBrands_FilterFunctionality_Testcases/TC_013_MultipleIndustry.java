...
public class TC_013_MultipleIndustry extends ITW_BaseClass{

	@Test(priority=9)
	public void MultipleIndustryTest() throws InterruptedException {
		...
		log.info("****TC_013_Multiple Industry Testcase Execution is Completed ****");
